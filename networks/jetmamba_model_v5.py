...
class OptimizedJetVisionMamba(nn.Module):
    ...
    def __init__(self, num_classes=10, d_model=128, n_layers=4, d_state=16, 
        ...
        # CORRECTED: Use exact YAML names for 15 channels
        self.channel_config = {
            # Energy features (exact YAML names)
            'part_pt_log': {'preprocess': 'none', 'normalize': False},        # Already log & standardized
            'part_e_log': {'preprocess': 'none', 'normalize': False},         # Already log & standardized
            'part_logptrel': {'preprocess': 'none', 'normalize': False},      # Already log & standardized
            'part_logerel': {'preprocess': 'none', 'normalize': False},       # Already log & standardized
            
            # Geometric features
            'part_deltaR': {'preprocess': 'none', 'normalize': False},        # Already standardized
            
            # Track parameters
            'part_d0': {'preprocess': 'none', 'normalize': False},            # Already tanh-transformed
            'part_d0err': {'preprocess': 'none', 'normalize': False},         # Already clipped [0,1]
            'part_dz': {'preprocess': 'none', 'normalize': False},            # Already tanh-transformed  
            'part_dzerr': {'preprocess': 'none', 'normalize': False},         # Already clipped [0,1]
            'part_charge': {'preprocess': 'none', 'normalize': False},
            
            # Particle ID features (binary)
