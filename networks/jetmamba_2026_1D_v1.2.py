...
class JetMamba2026_1D_v1_2(nn.Module):
    def __init__(
        self,
        num_classes=10,
        d_model=128,
        ...
        **kwargs
        ...
        super().__init__()
        if Mamba is None:
            raise ImportError("mamba_ssm is required for jetmamba_2026_1D_v1.2") from _MAMBA_IMPORT_ERROR
...
def get_model(data_config, **kwargs):
    ...
    model = JetMamba2026_1D_v1_2(**cfg)
    model_info = {
